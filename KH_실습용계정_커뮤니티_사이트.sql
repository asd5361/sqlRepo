...
--탈퇴
DELETE MEMBER WHERE ID = 'USER01' AND PWD='1234';
--마이페이지 조회
SELECT * FROM MEMBER WHERE ID ='USER01' AND PWD = '1234';
--게시글 작성
...
--게시글 상세 조회
SELECT TITLE,ENROLL_DATE,(SELECT NICK FROM MEMBER WHERE member.member_nO=board.WRITER_NO) WRITER
FROM board WHERE TITLE LIKE '제목%';
--게시글 제목 및 내용 수정
UPDATE BOARD SET TITLE = '제목입니다만' WHERE BOARD_NO = 1;
UPDATE BOARD SET CONTENT = '내용입니다만' WHERE BOARD_NO = 1;
--게시글 삭제
